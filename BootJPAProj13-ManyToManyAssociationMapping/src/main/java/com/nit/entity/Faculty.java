...
public class Faculty {
	...
	@JoinTable(name="JPA_FACULTY_STUDENT",joinColumns=@JoinColumn(name="FACULTY_ID",referencedColumnName = "fid")//owning side
	 ,inverseJoinColumns = @JoinColumn(name="STUDENT_ID",referencedColumnName = "sid"))// Inverse side
