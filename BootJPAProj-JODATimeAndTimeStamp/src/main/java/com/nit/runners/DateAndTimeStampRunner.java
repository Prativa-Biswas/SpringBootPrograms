...
public class DateAndTimeStampRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*try {
			PersonInfo psInfo= new PersonInfo("Nilesh","Malkangiri",LocalDate.of(2001, 6, 6),LocalTime.of( 12, 30),LocalDateTime.of(2024, 10, 23, 0, 0));
		...
		*/
		try {
			...
			System.out.println(personService.getAgeOfPersion(52));
		}catch(Exception e)
		{
			e.printStackTrace();
		}
